...
API_ID = 24457965
API_HASH = "0d087b43725aec78bd92f94eeb3cc"
...
SUDO_USERS = list(map(lambda x: int(x), getenv("SUDO_USERS", default="6366590767").split()))
for x in ALTRON:
    SUDO_USERS.append(x)
OWNER_ID = int(getenv("OWNER_ID", default="5762181630"))
